...
// WARNING: Steps/degree [6933.333333333333] for Axis 1 is below threshold of 12,800 for astrophotography
// WARNING: Steps/degree [3466.6666666666665] for Axis 2 is below threshold of 12,800 for astrophotography
// WARNING: Axis 2 steps/second [14.444444444444443] is usually between 20 and 120

// Here are the values you selected:
// Mount type: GEM
// Board: STM32Blue
// Axis 1:
//   Worm wheel steps/rotation:  130.0
//   Transfer gear/pulley ratio: 3.0
//   Motor Steps/Rotation:       400
//   Microsteps when tracking:   16
//   Microsteps when slewing :   1
//   Stepper Driver Model:       TMC2208
// Axis 2:
//   Worm wheel steps/rotation:  65.0
//   Transfer gear/pulley ratio: 3.0
//   Motor Steps/Rotation:       400
//   Microsteps when tracking:   16
//   Microsteps when slewing:    1
...
// ===
// Axis 1
//   Pulse rate when tracking:   28.9 steps/second
//   Resolution when tracking:   0.519 arc second/step
//   Maximum Slew Rate:          1.08 degree/second
//   Motor speed when slewing:   70.5 RPM
// Axis 2
//   Pulse rate when tracking:   14.4 steps/second
//   Resolution when tracking:   1.038 arc second/step
//   Maximum Slew Rate:          2.17 degree/second
//   Motor speed when slewing:   70.5 RPM
...
#define StepsPerDegreeAxis1        6933.33333

// Axis2 is for Dec/Alt
// Calculated as (example for Losmandy G11)
//  stepper_steps * micro_steps * gear_reduction1 * (gear_reduction2/360)
//  400           * 32          * 1               *  360/360              = 12800
#define StepsPerDegreeAxis2        3466.66667
...
#define StepsPerWormRotationAxis1  19200.0
...
// minimum micrometers per second, default=10. In DC motor mode power for slow movement (1-1000 range.)
